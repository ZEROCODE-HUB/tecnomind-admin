...
const TransferButton = ({ disabled = false, onClick, loading: externalLoading }: TransferButtonProps) => {
  ...
  return (
    <footer className="mt-auto px-4 pb-8 pt-4 bg-background/95 backdrop-blur-sm sticky bottom-16 md:bottom-0 z-10 w-full max-w-md mx-auto border-t border-transparent">
      <button
        ...
        className={`w-full font-bold text-lg h-14 rounded-full shadow-lg transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 group ring-2 ring-transparent focus:ring-accent/50 outline-none ${
          disabled || loading
