      ...
      <div className="container mx-auto px-4 lg:px-8 pt-32 lg:pt-40 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Subtitle */}
            <p className="text-lg md:text-xl text-primary-foreground/70 mb-10 max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative animate-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="relative z-10">
              ...
              <div className="relative mx-auto max-w-lg">
                <div className="bg-primary-foreground/10 backdrop-blur-xl rounded-2xl border border-primary-foreground/20 p-4 shadow-elevated">
                  {/* Browser Chrome */}
