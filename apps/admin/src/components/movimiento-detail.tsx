  ...
  return (
    <DetailModal
      ...
      rows={[
        ...
        { label: "Documento destino", value: <span className="font-mono tabular-nums">{m.cuit}</span> },
        { label: "Número de cuenta", value: <span className="font-mono text-xs">{m.cvu}</span> },
